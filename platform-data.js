...
module.exports = {
    alsion: {
        ...
        formerStudentStatus: "alumnus",
        teacherStatus: "faculty",
        updateTime: "0 0 0 1 7 *",
    ...
    generic: {
        ...
        studentStatuses: ["guest"],
        formerStudentStatus: "average",
        teacherStatus: "elite",
        permissionsProperty: ["default", "mod", "admin", "principal"],
        permissionsDisplay: ["Default", "Moderator", "Administrator", "Principal"],
        tags: ["Example Tag"],
        ...
        info: [{
            ...
            heading: "Finibus Bonorum et Malorum",
            text: [
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
                "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
            ],
