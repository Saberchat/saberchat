...
router.get('/new', middleware.isLoggedIn, middleware.isMod, wrapAsync(Announcement.new));

router.get('/mark-all', middleware.isLoggedIn, wrapAsync(Announcement.markAll));

router.get('/mark/:id', middleware.isLoggedIn, wrapAsync(Announcement.markOne));
