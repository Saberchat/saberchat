...
router.route('/')
    .get(middleware.isLoggedIn, middleware.cafeOpen, cafeController.index) //View homepage, view menu or view form to create new order
    .post(middleware.isLoggedIn, middleware.cafeOpen, cafeController.order) //Create new order
    .put(middleware.isLoggedIn, cafeController.upvote); //Upvote item

router.route('/order/:id')
    .put(middleware.isLoggedIn, middleware.isCashier, cafeController.processOrder) //Confirm order
    .delete(middleware.isLoggedIn, middleware.cafeOpen, cafeController.deleteOrder); //Reject/cancel order
...
router.route('/item/:id')
    ...
    .put(middleware.isLoggedIn, middleware.isCashier, cafeController.updateItem) //Update item
