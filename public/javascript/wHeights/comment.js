    ...
    if (document.getElementById('comment-input').value.split(' ').join('') != '') {
        ...
        $.post(url, data, data => {
            ...
            if (data.success) {
                ...
                let commentHTML = `<img src="${data.comments[data.comments.length - 1].sender.imageUrl.url}" alt="user" class="user-image"><div class="media-body ml-3"><div class="bg-primary rounded py-2 px-3 mb-2 w-75"><p class="text-small mb-0 text-white">`;
